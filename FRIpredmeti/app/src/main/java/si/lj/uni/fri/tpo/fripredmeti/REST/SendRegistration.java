...
public class SendRegistration extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try{
            ...
            String SERVICE_URL = "http://friaplikacija.azurewebsites.net/Service.svc/Register";
            ...
            connection.setRequestProperty("uporabniskoIme", params[2]);
            connection.connect();
            ...
            result = jsonObject.getString("verificationCode");
